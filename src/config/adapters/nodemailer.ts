...
const { EMAIL_USER, EMAIL_PASSWORD, DOMAIN_APP } = envs;
        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; padding: 20px; color: #444;">
                    ...
                    <a href="${DOMAIN_APP}/auth/activate-account/?token=${token}" style="background-color: #357b38; color: #fff; text-decoration: none; padding: 10px 20px; margin: 10px 0; display: inline-block;">Verificar cuenta</a>
